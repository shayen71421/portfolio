...
const projects = [
{
    ...
    description: 'The official web portal for the Innovation and Entrepreneurship Development Cell (IEDC) at Sahrdaya College. It serves as a hub for activities, events, and resources related to innovation and entrepreneurship, providing easy access to information about initiatives and programs of IEDC Sahrdaya.',
